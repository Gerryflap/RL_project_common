...
if __name__ == '__main__':
    ...
    q_network = QNetwork((2,), actions, tasks, common_net,
                         ...
                         gamma=0.9, alpha=0.001, reward_scale=1.0, fixed_steps=10, lambd=0.9, lambd_min=1e-4
                         )
    p_network = PolicyNetwork((2,), actions, tasks, common_net,
                         task_p_net, lambda s: s.state, entropy_regularization=0.05, alpha=0.001, fixed_steps=10)
