...
state_scaling_factors = np.array([2, 1.4, 3.3, 2.4, 2 * np.math.pi, 11.4, 1, 1])
...
def get_state_transformer(noise_standard_deviation=0.0):
    noise = np.random.normal(0, noise_standard_deviation, (8,))
    noise *= state_scaling_factors
